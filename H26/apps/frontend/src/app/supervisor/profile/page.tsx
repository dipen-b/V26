...
export default function ProfilePage() {
  ...
  return (
    <div className="p-8 space-y-6">
      ...
      <div className="bg-blue-900/20 border border-blue-800 rounded-lg p-6 max-w-2xl">
        <h2 className="text-lg font-bold text-blue-400 mb-4">Supervisor Privileges</h2>
        <ul className="space-y-2 text-blue-300 text-sm">
          <li>✓ Manage and evaluate team members</li>
          <li>✓ View team analytics and performance metrics</li>
          <li>✓ Create and approve employee evaluations</li>
          <li>✓ Override AI recommendations</li>
          <li>✓ Access detailed performance history</li>
        </ul>
      </div>
    </div>
  );
