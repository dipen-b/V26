...
const project_entity_1 = require("./common/entities/project.entity");
    ...
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forRoot({
                ...
                entities: [user_entity_1.User, task_entity_1.Task, project_entity_1.Project, submission_entity_1.Submission, evaluation_entity_1.Evaluation, performance_metric_entity_1.PerformanceMetric],
                synchronize: true,
